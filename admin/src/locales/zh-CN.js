export default {
  ...
  'menu.source': '资源设置',
  'menu.source.center': '图片设置',
  'menu.source.settings': '视频设置',
  ...
  'app.settings.menuMap.basic': '活动设置',
  ...
  'app.settings.basic.nickname': '活动标题',
  'app.settings.basic.nickname-message': '请输入活动标题!',
  'app.settings.basic.profile': '活动内容',
  'app.settings.basic.profile-message': '请输入活动内容!',
  'app.settings.basic.profile-placeholder': '活动内容',
  ...
  'menu.order-view': '订单查看',
  'menu.invest-manage': '投资管理',
  'menu.code-produce': '代码生成',
  'menu.activeity-manage': '活动管理',
  'menu.test': '视频管理',
};
